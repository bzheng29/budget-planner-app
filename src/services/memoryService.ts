  ...
  extractMemoryFromExpenses(
    ...
    const profile: UserMemoryProfile = {
      ...
      spending: {
        ...
        categoryBreakdown: {
          housing: categoryTotals['Housing'] || avgMonthlySpend * 0.25,
          food: categoryTotals['Food & Dining'] || avgMonthlySpend * 0.2,
          transportation: categoryTotals['Transportation'] || avgMonthlySpend * 0.12,
          entertainment: categoryTotals['Entertainment'] || avgMonthlySpend * 0.05,
          healthcare: categoryTotals['Healthcare'] || avgMonthlySpend * 0.05,
          insurance: categoryTotals['Insurance'] || avgMonthlySpend * 0.03,
          utilities: categoryTotals['Bills & Utilities'] || avgMonthlySpend * 0.08,
          shopping: categoryTotals['Shopping'] || avgMonthlySpend * 0.12,
          education: categoryTotals['Education'] || (lifestyle.hasKids ? avgMonthlySpend * 0.15 : 0),
          childcare: lifestyle.hasKids ? categoryTotals['Childcare'] || avgMonthlySpend * 0.08 : undefined,
          debtPayments: metadata.insights.hasDebt ? avgMonthlySpend * 0.1 : undefined,
